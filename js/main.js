...
var gameloop = setInterval(function() {
    if (ticking) return;
    ticking = true;
    update();update(needUpdateUI = false);update(needUpdateUI = false);update(needUpdateUI = false);update(needUpdateUI = false);update(needUpdateUI = false);update(needUpdateUI = false);update(needUpdateUI = false);
